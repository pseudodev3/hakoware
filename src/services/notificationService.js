...
export const NOTIFICATION_TYPES = {
  ...
  POKE: 'POKE',
  MUTUAL_POKE: 'MUTUAL_POKE',
  HOT_SEAT_OPENED: 'HOT_SEAT_OPENED',
  HOT_SEAT_ANSWERED: 'HOT_SEAT_ANSWERED',
  HOT_SEAT_REVEALED: 'HOT_SEAT_REVEALED',
  SPLIT_DECISION_OPENED: 'SPLIT_DECISION_OPENED',
  SPLIT_DECISION_ANSWERED: 'SPLIT_DECISION_ANSWERED',
  SPLIT_DECISION_REVEALED: 'SPLIT_DECISION_REVEALED',
  DOUBLE_DARE_SENT: 'DOUBLE_DARE_SENT',
  DOUBLE_DARE_REVEALED: 'DOUBLE_DARE_REVEALED',
