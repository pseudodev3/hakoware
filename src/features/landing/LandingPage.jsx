    ...
    <div className="lp-root">
      ...
      <main>
        ...
        <section className="lp-pressure-section">
          ...
          <div className="lp-pressure-grid">
            ...
            <div className="lp-recap-preview">
              ...
              <div className="lp-recap-brand"><img src="/hakoware-mark.svg" alt="" /><span>HAKOWARE · SEASON 03</span></div>
            </div>
          </div>
        </section>
        ...
        <section className="lp-final-section">
          <div className="lp-final-mark"><img src="/hakoware-mark.svg" alt="" /></div>
      ...
      <footer className="lp-footer">
        <div className="lp-brand"><img src="/hakoware-mark.svg" alt="" /><div><strong>Hakoware</strong><span>built as its own world</span></div></div>
