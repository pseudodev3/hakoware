...
- Hot Seat uses a broad prompt bank and anti-repeat selection: avoid the contract's last 10 Hot Seat prompts and the platform's most recent 6 prompt IDs before choosing; both sides of the same Hot Seat still receive the same prompt by design;
